...
export default function Error404() {
    return (
        <>
            <div
                className="grid min-h-full grid-cols-1 grid-rows-[1fr,auto,1fr] bg-gray-300 lg:grid-cols-[max(50%,36rem),1fr]">
                <header
                ...
                <main
                    ...
                    <div className="max-w-lg">
                        ...
                        <div className="mt-10">
                            <a href="/" className="text-sm font-semibold leading-7 text-cyan-600">
                ...
                <div className="self-end lg:col-span-2 lg:col-start-1 lg:row-start-3">
                    <div className="border-t border-gray-100 bg-gray-50 py-10">
                        <nav
                            className="mx-auto flex w-full max-w-7xl items-center gap-x-4 px-6 text-sm leading-7 text-gray-600 lg:px-8">
