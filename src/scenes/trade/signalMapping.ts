...
export const COMPONENTS: ComponentDef[] = [
    ...
    },
    {
        ...
        signals: [
            // Tier 3 (weight 3) — rare, high-significance patterns
            {key: 'cdl_abandonedbaby', label: 'Abandoned Baby', type: 'event', color: '#06b6d4', tier: 3},
            {key: 'cdl_concealbabyswallow', label: 'Conceal Baby Swallow', type: 'event', color: '#06b6d4', tier: 3},
            {key: 'cdl_uniquethreeriver', label: 'Unique Three River', type: 'event', color: '#06b6d4', tier: 3},
            {key: 'cdl_threestarsinSouth', label: 'Three Stars South', type: 'event', color: '#06b6d4', tier: 3},
            {key: 'cdl_kicking', label: 'Kicking', type: 'event', color: '#06b6d4', tier: 3},
            {key: 'cdl_kickingbylength', label: 'Kicking By Length', type: 'event', color: '#06b6d4', tier: 3},
            // Tier 2 (weight 2) — multi-candle reversal patterns
            {key: 'cdl_morningstar', label: 'Morning Star', type: 'event', color: '#22d3ee', tier: 2},
            {key: 'cdl_eveningstar', label: 'Evening Star', type: 'event', color: '#22d3ee', tier: 2},
            {key: 'cdl_morningdojistar', label: 'Morning Doji Star', type: 'event', color: '#22d3ee', tier: 2},
            {key: 'cdl_eveningdojistar', label: 'Evening Doji Star', type: 'event', color: '#22d3ee', tier: 2},
            {key: 'cdl_breakaway', label: 'Breakaway', type: 'event', color: '#22d3ee', tier: 2},
            {key: 'cdl_mathold', label: 'Mat Hold', type: 'event', color: '#22d3ee', tier: 2},
            {key: 'cdl_risefall3methods', label: 'Rise/Fall 3 Methods', type: 'event', color: '#22d3ee', tier: 2},
            {key: 'cdl_threesoldierscrows', label: 'Three Soldiers/Crows', type: 'event', color: '#22d3ee', tier: 2},
            {key: 'cdl_identicalthreecrows', label: 'Identical Three Crows', type: 'event', color: '#22d3ee', tier: 2},
            {key: 'cdl_ladderbottom', label: 'Ladder Bottom', type: 'event', color: '#22d3ee', tier: 2},
            {key: 'cdl_advanceblock', label: 'Advance Block', type: 'event', color: '#22d3ee', tier: 2},
            {key: 'cdl_tristar', label: 'Tristar', type: 'event', color: '#22d3ee', tier: 2},
            {key: 'cdl_threeinside', label: 'Three Inside', type: 'event', color: '#22d3ee', tier: 2},
            {key: 'cdl_threeoutside', label: 'Three Outside', type: 'event', color: '#22d3ee', tier: 2},
            {key: 'cdl_threelinestrike', label: 'Three Line Strike', type: 'event', color: '#22d3ee', tier: 2},
            // Tier 1 (weight 1) — single-candle / common patterns
            {key: 'cdl_engulfing', label: 'Engulfing', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_harami', label: 'Harami', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_haramicross', label: 'Harami Cross', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_darkcloudcover', label: 'Dark Cloud Cover', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_piercing', label: 'Piercing', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_hammer', label: 'Hammer', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_hangingman', label: 'Hanging Man', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_invertedhammer', label: 'Inverted Hammer', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_shootingstar', label: 'Shooting Star', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_doji', label: 'Doji', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_dojistar', label: 'Doji Star', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_dragonflydoji', label: 'Dragonfly Doji', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_gravestonedoji', label: 'Gravestone Doji', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_longleggeddoji', label: 'Long Legged Doji', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_rickshawman', label: 'Rickshaw Man', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_spinningtop', label: 'Spinning Top', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_highwave', label: 'High Wave', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_marubozu', label: 'Marubozu', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_matchinglow', label: 'Matching Low', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_homingpigeon', label: 'Homing Pigeon', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_belthold', label: 'Belt Hold', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_counterattack', label: 'Counterattack', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_stalledpattern', label: 'Stalled Pattern', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_takuri', label: 'Takuri', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_twocrows', label: 'Two Crows', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_upsidegap2crows', label: 'Upside Gap 2 Crows', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_gapsideSidewhite', label: 'Gap Side White', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_tasukigap', label: 'Tasuki Gap', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_thrusting', label: 'Thrusting', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_inneck', label: 'In Neck', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_onneck', label: 'On Neck', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_separatinglines', label: 'Separating Lines', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_hikkake', label: 'Hikkake', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_hikkakemod', label: 'Hikkake Mod', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_shortline', label: 'Short Line', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_longline', label: 'Long Line', type: 'event', color: '#67e8f9', tier: 1},
            {key: 'cdl_sticksandwich', label: 'Stick Sandwich', type: 'event', color: '#67e8f9', tier: 1},
        ],
    },
];
