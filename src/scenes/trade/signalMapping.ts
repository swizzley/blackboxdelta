...
export const COMPONENTS: ComponentDef[] = [
    ...
    },
    {
        ...
        signals: [
            ...
            {key: 'cdl_abandonedbaby', label: 'Abandoned Baby', type: 'event', color: '#06b6d4', tier: 3, patternShape: 'circle'},
            {key: 'cdl_concealbabyswallow', label: 'Conceal Baby Swallow', type: 'event', color: '#06b6d4', tier: 3, patternShape: 'circle'},
            {key: 'cdl_uniquethreeriver', label: 'Unique Three River', type: 'event', color: '#06b6d4', tier: 3, patternShape: 'circle'},
            {key: 'cdl_threestarsinSouth', label: 'Three Stars South', type: 'event', color: '#06b6d4', tier: 3, patternShape: 'circle'},
            {key: 'cdl_kicking', label: 'Kicking', type: 'event', color: '#06b6d4', tier: 3, patternShape: 'square'},
            {key: 'cdl_kickingbylength', label: 'Kicking By Length', type: 'event', color: '#06b6d4', tier: 3, patternShape: 'square'},
            // Tier 2 (weight 2) — multi-candle reversal patterns (circle = 3-candle, square = 2-candle)
            {key: 'cdl_morningstar', label: 'Morning Star', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle'},
            {key: 'cdl_eveningstar', label: 'Evening Star', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle'},
            {key: 'cdl_morningdojistar', label: 'Morning Doji Star', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle'},
            {key: 'cdl_eveningdojistar', label: 'Evening Doji Star', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle'},
            {key: 'cdl_breakaway', label: 'Breakaway', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle'},
            {key: 'cdl_mathold', label: 'Mat Hold', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle'},
            {key: 'cdl_risefall3methods', label: 'Rise/Fall 3 Methods', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle'},
            {key: 'cdl_threesoldierscrows', label: 'Three Soldiers/Crows', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle'},
            {key: 'cdl_identicalthreecrows', label: 'Identical Three Crows', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle'},
            {key: 'cdl_ladderbottom', label: 'Ladder Bottom', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle'},
            {key: 'cdl_advanceblock', label: 'Advance Block', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle'},
            {key: 'cdl_tristar', label: 'Tristar', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle'},
            {key: 'cdl_threeinside', label: 'Three Inside', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle'},
            {key: 'cdl_threeoutside', label: 'Three Outside', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle'},
            {key: 'cdl_threelinestrike', label: 'Three Line Strike', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle'},
            // Tier 1 (weight 1) — two-candle patterns get square, single-candle get arrow
            {key: 'cdl_engulfing', label: 'Engulfing', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_harami', label: 'Harami', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_haramicross', label: 'Harami Cross', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_darkcloudcover', label: 'Dark Cloud Cover', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_piercing', label: 'Piercing', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_hammer', label: 'Hammer', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow'},
            {key: 'cdl_hangingman', label: 'Hanging Man', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow'},
            {key: 'cdl_invertedhammer', label: 'Inverted Hammer', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow'},
            {key: 'cdl_shootingstar', label: 'Shooting Star', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow'},
            {key: 'cdl_doji', label: 'Doji', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_dojistar', label: 'Doji Star', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_dragonflydoji', label: 'Dragonfly Doji', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow'},
            {key: 'cdl_gravestonedoji', label: 'Gravestone Doji', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow'},
            {key: 'cdl_longleggeddoji', label: 'Long Legged Doji', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_rickshawman', label: 'Rickshaw Man', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_spinningtop', label: 'Spinning Top', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_highwave', label: 'High Wave', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_marubozu', label: 'Marubozu', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow'},
            {key: 'cdl_matchinglow', label: 'Matching Low', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_homingpigeon', label: 'Homing Pigeon', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_belthold', label: 'Belt Hold', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow'},
            {key: 'cdl_counterattack', label: 'Counterattack', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_stalledpattern', label: 'Stalled Pattern', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'circle'},
            {key: 'cdl_takuri', label: 'Takuri', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow'},
            {key: 'cdl_twocrows', label: 'Two Crows', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_upsidegap2crows', label: 'Upside Gap 2 Crows', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'circle'},
            {key: 'cdl_gapsideSidewhite', label: 'Gap Side White', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_tasukigap', label: 'Tasuki Gap', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_thrusting', label: 'Thrusting', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_inneck', label: 'In Neck', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_onneck', label: 'On Neck', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_separatinglines', label: 'Separating Lines', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square'},
            {key: 'cdl_hikkake', label: 'Hikkake', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'circle'},
            {key: 'cdl_hikkakemod', label: 'Hikkake Mod', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'circle'},
            {key: 'cdl_shortline', label: 'Short Line', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow'},
            {key: 'cdl_longline', label: 'Long Line', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow'},
            {key: 'cdl_sticksandwich', label: 'Stick Sandwich', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'circle'},
        ],
    },
];
