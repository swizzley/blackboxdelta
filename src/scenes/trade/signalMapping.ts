...
export interface SignalDef {
    ...
    abbrev?: string;       // TradingView-style short abbreviation for candle patterns
}
...
export const COMPONENTS: ComponentDef[] = [
    ...
    },
    {
        ...
        signals: [
            ...
            {key: 'sar', label: 'SAR', type: 'overlay', color: '#facc15', render: 'dots'},
            {key: 'sar_ext', label: 'SAR Ext', type: 'overlay', color: '#fde047', render: 'dots'},
    ...
    },
    {
        ...
        signals: [
            // Tier 3 (weight 3) — rare, high-significance multi-candle patterns
            {key: 'cdl_abandonedbaby', label: 'Abandoned Baby', type: 'event', color: '#06b6d4', tier: 3, patternShape: 'circle', abbrev: 'AB'},
            {key: 'cdl_concealbabyswallow', label: 'Conceal Baby Swallow', type: 'event', color: '#06b6d4', tier: 3, patternShape: 'circle', abbrev: 'CBS'},
            {key: 'cdl_uniquethreeriver', label: 'Unique Three River', type: 'event', color: '#06b6d4', tier: 3, patternShape: 'circle', abbrev: 'U3R'},
            {key: 'cdl_threestarsinSouth', label: 'Three Stars South', type: 'event', color: '#06b6d4', tier: 3, patternShape: 'circle', abbrev: '3SS'},
            {key: 'cdl_kicking', label: 'Kicking', type: 'event', color: '#06b6d4', tier: 3, patternShape: 'square', abbrev: 'K'},
            {key: 'cdl_kickingbylength', label: 'Kicking By Length', type: 'event', color: '#06b6d4', tier: 3, patternShape: 'square', abbrev: 'KL'},
            // Tier 2 (weight 2) — multi-candle reversal patterns
            {key: 'cdl_morningstar', label: 'Morning Star', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle', abbrev: 'MS'},
            {key: 'cdl_eveningstar', label: 'Evening Star', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle', abbrev: 'ES'},
            {key: 'cdl_morningdojistar', label: 'Morning Doji Star', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle', abbrev: 'MDS'},
            {key: 'cdl_eveningdojistar', label: 'Evening Doji Star', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle', abbrev: 'EDS'},
            {key: 'cdl_breakaway', label: 'Breakaway', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle', abbrev: 'Brk'},
            {key: 'cdl_mathold', label: 'Mat Hold', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle', abbrev: 'MH'},
            {key: 'cdl_risefall3methods', label: 'Rise/Fall 3 Methods', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle', abbrev: '3M'},
            {key: 'cdl_threesoldierscrows', label: 'Three Soldiers/Crows', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle', abbrev: '3SC'},
            {key: 'cdl_identicalthreecrows', label: 'Identical Three Crows', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle', abbrev: 'I3C'},
            {key: 'cdl_ladderbottom', label: 'Ladder Bottom', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle', abbrev: 'LB'},
            {key: 'cdl_advanceblock', label: 'Advance Block', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle', abbrev: 'AdvB'},
            {key: 'cdl_tristar', label: 'Tristar', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle', abbrev: 'Tri'},
            {key: 'cdl_threeinside', label: 'Three Inside', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle', abbrev: '3In'},
            {key: 'cdl_threeoutside', label: 'Three Outside', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle', abbrev: '3Out'},
            {key: 'cdl_threelinestrike', label: 'Three Line Strike', type: 'event', color: '#22d3ee', tier: 2, patternShape: 'circle', abbrev: '3LS'},
            // Tier 1 (weight 1) — single/two-candle patterns
            {key: 'cdl_engulfing', label: 'Engulfing', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'Eng'},
            {key: 'cdl_harami', label: 'Harami', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'Har'},
            {key: 'cdl_haramicross', label: 'Harami Cross', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'HarX'},
            {key: 'cdl_darkcloudcover', label: 'Dark Cloud Cover', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'DCC'},
            {key: 'cdl_piercing', label: 'Piercing', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'Prc'},
            {key: 'cdl_hammer', label: 'Hammer', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow', abbrev: 'H'},
            {key: 'cdl_hangingman', label: 'Hanging Man', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow', abbrev: 'HM'},
            {key: 'cdl_invertedhammer', label: 'Inverted Hammer', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow', abbrev: 'IH'},
            {key: 'cdl_shootingstar', label: 'Shooting Star', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow', abbrev: 'SS'},
            {key: 'cdl_doji', label: 'Doji', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'D'},
            {key: 'cdl_dojistar', label: 'Doji Star', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'DS'},
            {key: 'cdl_dragonflydoji', label: 'Dragonfly Doji', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow', abbrev: 'DfD'},
            {key: 'cdl_gravestonedoji', label: 'Gravestone Doji', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow', abbrev: 'GsD'},
            {key: 'cdl_longleggeddoji', label: 'Long Legged Doji', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'LLD'},
            {key: 'cdl_rickshawman', label: 'Rickshaw Man', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'RM'},
            {key: 'cdl_spinningtop', label: 'Spinning Top', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'ST'},
            {key: 'cdl_highwave', label: 'High Wave', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'HW'},
            {key: 'cdl_marubozu', label: 'Marubozu', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow', abbrev: 'Maru'},
            {key: 'cdl_matchinglow', label: 'Matching Low', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'ML'},
            {key: 'cdl_homingpigeon', label: 'Homing Pigeon', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'HP'},
            {key: 'cdl_belthold', label: 'Belt Hold', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow', abbrev: 'BH'},
            {key: 'cdl_counterattack', label: 'Counterattack', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'CA'},
            {key: 'cdl_stalledpattern', label: 'Stalled Pattern', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'circle', abbrev: 'StP'},
            {key: 'cdl_takuri', label: 'Takuri', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow', abbrev: 'Tak'},
            {key: 'cdl_twocrows', label: 'Two Crows', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: '2C'},
            {key: 'cdl_upsidegap2crows', label: 'Upside Gap 2 Crows', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'circle', abbrev: 'UG2C'},
            {key: 'cdl_gapsideSidewhite', label: 'Gap Side White', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'GSW'},
            {key: 'cdl_tasukigap', label: 'Tasuki Gap', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'TG'},
            {key: 'cdl_thrusting', label: 'Thrusting', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'Thr'},
            {key: 'cdl_inneck', label: 'In Neck', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'IN'},
            {key: 'cdl_onneck', label: 'On Neck', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'ON'},
            {key: 'cdl_separatinglines', label: 'Separating Lines', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'square', abbrev: 'SL'},
            {key: 'cdl_hikkake', label: 'Hikkake', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'circle', abbrev: 'Hik'},
            {key: 'cdl_hikkakemod', label: 'Hikkake Mod', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'circle', abbrev: 'HikM'},
            {key: 'cdl_shortline', label: 'Short Line', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow', abbrev: 'ShL'},
            {key: 'cdl_longline', label: 'Long Line', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'arrow', abbrev: 'LoL'},
            {key: 'cdl_sticksandwich', label: 'Stick Sandwich', type: 'event', color: '#67e8f9', tier: 1, patternShape: 'circle', abbrev: 'StS'},
        ],
    },
];
